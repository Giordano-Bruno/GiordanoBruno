 ...
 */
  ...
  include_once("../classes/LocaleQuery.php");//jal 5/jul/2015 para alx mu.ltiidioma
  ...
  define("OBIB_LIBRARY_ADERS",$set->getLibraryAders());
...
//jal 5/jul/2015 para alx mu.ltiidioma  ---->
  if (isset($_GET["local"]))
    $_SESSION["lang"] = $_GET["local"];
  if (isset($_GET["lang"]))
    $_SESSION["lang"] = $_GET["lang"];
  if (isset($_SESSION["lang"]))
    define("OBIB_LOCALE",$_SESSION["lang"]);
  else {
...
//jal 5/jul/2015 para alx mu.ltiidioma    ----<
  ...
  //$themeQ->connect();//jal 5/jul/2015 para alx mu.ltiidioma 
  $themeQ->uselocale = "";//jal 5/jul/2015 para alx mu.ltiidioma 
