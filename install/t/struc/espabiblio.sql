...
CREATE TABLE IF NOT EXISTS `cdd` (
  `cdd_Bid` int(11) NOT NULL AUTO_INCREMENT,
  `cdd_Numero` text,
  `cdd_Descripcion` text,
  `cdd_Clave` text,
  `cdd_Table` text,
  PRIMARY KEY (`cdd_Bid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9455 ;
...
CREATE TABLE IF NOT EXISTS `ibic` (
  `ibic_Bid` int(11) NOT NULL AUTO_INCREMENT,
  `ibic_Numero` text,
  `ibic_Descripcion` text,
  `ibic_Clave` text,
  `ibic_Table` text,
  PRIMARY KEY (`ibic_Bid`)
