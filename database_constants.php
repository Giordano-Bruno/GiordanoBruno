...
define("OBIB_DATABASE", "GiordanoBruno");// La base de datos donde guardan sus datos las tablas.
define("OBIB_USERNAME", "espabiblio");// El usuario para mysql
define("OBIB_PWD",      "espabiblio");//el password sin ecriptar
define("DB_CHARSET",    "utf-8");// define el charset de la base de datos
