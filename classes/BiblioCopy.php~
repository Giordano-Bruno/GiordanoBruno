...
class BiblioCopy {
  ...
  var $_loc;
  var $_renewalCount = "";
  var $_custom = array(); // jalg multi 5-7-2015 ALX
  var $_usMARC_hold = array(); // jalg multi 5-7-2015 ALX
  ...
  function validateData($validBarco) { // jalg multi 5-7-2015 ALX
    $valid = true;
...
*/
  ...
  function getCustom($field) { // jalg multi 5-7-2015 ALX
  ...
  function setCustom($field, $value) { // jalg multi 5-7-2015 ALX
