...
require_once("../classes/LocaleQuery.php");//jalg multi 05-07-2015
...
class SettingsQuery extends Query {
  ...
  function fetchRow() {
    ...
    $set->setLibraryAders($array["library_aders"]);
  ...
  function update($set) {
    ...
    $sql = $this->mkSQL("update settings set "
                        ...
                        . "library_aders=%Q, library_phone=%Q, library_url=%Q, "
                        ...
                        $set->getLibraryHours(), $set->getLibraryAders(), $set->getLibraryPhone(), 
