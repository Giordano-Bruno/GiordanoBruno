...
class UsmarcTagDmQuery extends Query {
  ...
  function execSelect($blockNmbr = "") {
    $sql = $this->mkSQL("select block_nmbr, tag, %L as description, %L as ind1_description, %L as ind2_description from usmarc_tag_dm "
                , "usmarc_tag_dm.description"
                , "usmarc_tag_dm.ind1_description"
                , "usmarc_tag_dm.ind2_description"
                );
    if ($blockNmbr != "") {
  ...
  function doQuery($tag) {
    $sql = $this->mkSQL("select block_nmbr, tag, %L as description, %L as ind1_description, %L as ind2_description from usmarc_tag_dm where tag=%N "
                , "usmarc_tag_dm.description"
                , "usmarc_tag_dm.ind1_description"
                , "usmarc_tag_dm.ind2_description"
                , $tag
