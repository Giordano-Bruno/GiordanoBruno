...
class BiblioQuery extends Query {
  ...
  function __construct() { // jalg multi 5-7-2015
    parent::__construct();
...
//  $this->Query();
  ...
  /*###########################
    ...
    ###########################*/
  function doQuery($bibid, $tab="cataloging") { // jalg multi 5-7-2015
    # reset rowNmbr
    $this->_rowNmbr = 0;
...
*/
    ...
    while ($array = $this->_conn->fetchRow()) {
      ...
      if ($tab == "opac" and in_array($tag.$subfieldCd, $exclude)) continue; // jalg multi 5-7-2015
...
//    $sql = $this->mkSQL("insert into biblio values(null, sysdate(), sysdate(), " // jalg multi 5-7-2015 ALX
      ...
      if ($value->getFieldData() == "") {
        ...
        if ($value->getFieldid() == "") {
          ...
          $sql = $this->mkSQL("delete from biblio_field "
                                ...
                                $value->getBibid(), $value->getFieldid());//jalg de alx 8-7-2015
//                                $bibid, $value->getFieldid());
        ...
        $sql = $this->mkSQL("update biblio_field set field_data = %Q "
                            . "where bibid=%N and fieldid=%N ",
                            $value->getFieldData(), $value->getBibid(),//jalg de alx 8-7-2015
