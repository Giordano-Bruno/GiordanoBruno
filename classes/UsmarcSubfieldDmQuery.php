...
class UsmarcSubfieldDmQuery extends Query {
  ...
  function execSelect($tag = "") {
    $sql = $this->mkSQL("select *, %L as description from usmarc_subfield_dm ", "usmarc_subfield_dm.description");
    if ($tag != "") {
  ...
  function doQuery($tag, $subfld) {
    $sql = $this->mkSQL("select *, %L as description from usmarc_subfield_dm "
                        . "where tag=%N and subfield_cd=%Q "
                        , "usmarc_subfield_dm.description", 
                        $tag, $subfld);
