 ...
 */
  ...
  $set->setLibraryAders($_POST["libraryAders"]);
  $_POST["libraryAders"] = $set->getLibraryAders();
  ...
  $set->setCharset("");//$_POST["charset"] //jalg multi
  //$set->setCharset(DB_CHARSET);
//  $set->setCharset($_POST["charset"]);
  ...
  if (isset($_POST["UpdateLang"])){ //jalg multi 5-07-2015
    //require_once("../shared/logincheck.php");
