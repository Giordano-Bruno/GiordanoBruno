...
?>
<?php //jalg multi 5-07-2015
	if ($set->getVersion() != OBIB_LATEST_DB_VERSION){
?>
    <h3> current DB version <?php echo H($set->getVersion()); ?> not same as latest: <?php echo H(OBIB_LATEST_DB_VERSION); ?>
	<form name="updateForm" method="POST" action="../install/update.php">
	  <input type="submit" value="Update">
	</form>
	</h3>
<?php /*
	<a href="../admin/index.php" class="alt"> <?php echo $navLoc->getText("adminSummary"); //jalg multi 5-07-2015 ?> </a>
*/
?>
<?php 
		}
...
//            echo ">".H($langDesc)."</option>\n";//jalg multi 5-07-2015
            echo "> (".H($langCode).") ".H($langDesc)."</option>\n";
